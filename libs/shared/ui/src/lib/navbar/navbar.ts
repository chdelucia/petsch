...
export class ChNavbar {
  ...
  // Optimization: Use computed signal to memoize the apps array.
  // This prevents unnecessary re-creations of the array and ensures efficient
  // change detection in a zoneless environment.
  apps = computed(() => [
    {
      id: 'petshop',
      name: 'navbar.petshop',
