...
export class ChNavbar {
  ...
  // Refactor: Use computed signal to ensure the apps list is memoized and follows the signal architecture
  apps = computed(() => [
    {
      id: 'petshop',
      name: 'navbar.petshop',
      url: this.isLocal ? 'http://localhost:4200/' : 'https://petsch.vercel.app/',
    },
    {
      id: 'rickymorty',
